...
ps2exe .\src\TokenMonitor.ps1 .\TokenMonitor.exe -STA -noConsole -title TokenMonitor -product TokenMonitor -version 1.2.2 -embedFiles @{'.\src\TokenUsage.psm1'='.\src\TokenUsage.psm1'}
```
