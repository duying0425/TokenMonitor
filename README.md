...
ps2exe .\src\TokenMonitor.ps1 .\TokenMonitor.exe -STA -noConsole -title TokenMonitor -product TokenMonitor -version 1.2.3 -embedFiles @{'.\TokenUsage.psm1'='.\src\TokenUsage.psm1'}
```
